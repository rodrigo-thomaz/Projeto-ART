...
{
    public class PessoaFisicaDetailViewDTO : PessoaDetailDTO
    {
        ...
        private readonly CBOOcupacaoSelectViewDTO _cboOcupacao;
        private readonly CBOSinonimoSelectViewDTO _cboSinonimo;

        public PessoaFisicaDetailViewDTO
            (
                  long pessoaId
                , string primeiroNome
                , string nomeDoMeio
                ...
                , CBOOcupacaoSelectViewDTO cboOcupacao
                , CBOSinonimoSelectViewDTO cboSinonimo
                , bool ativo
                , string descricao
            ...
            )
        {
            ...
            _cboOcupacao = cboOcupacao;
            _cboSinonimo = cboSinonimo;
        }
        ...
        public CBOOcupacaoSelectViewDTO CBOOcupacao { get { return _cboOcupacao; } }
        public CBOSinonimoSelectViewDTO CBOSinonimo { get { return _cboSinonimo; } }
    }
}