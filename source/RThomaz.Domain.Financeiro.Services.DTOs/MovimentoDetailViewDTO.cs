...
{
    public class MovimentoDetailViewDTO
    {
        ...
        private MovimentoImportacaoDetailViewDTO _movimentoImportacao;
        private readonly bool _estaConciliado;

        public MovimentoDetailViewDTO
            (
                  long movimentoId
                ...
                , string historico
                , string observacao
                , MovimentoImportacaoDetailViewDTO movimentoImportacao
                , bool estaConciliado
            )
        {
            ...
            _movimentoImportacao = movimentoImportacao;
        ...
        public MovimentoImportacaoDetailViewDTO MovimentoImportacao { get { return _movimentoImportacao; } }
