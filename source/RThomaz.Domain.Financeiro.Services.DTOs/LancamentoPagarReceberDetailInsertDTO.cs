...
{
    public class LancamentoPagarReceberDetailInsertDTO
    {
        ...
        private readonly List<ConciliacaoDetailUpdateDTO> _conciliacoes;
        private readonly string _historico;
        private readonly string _numero;
        private readonly string _observacao;

        public LancamentoPagarReceberDetailInsertDTO
            (
                ...
                , List<ConciliacaoDetailUpdateDTO> conciliacoes
                , string historico
                , string numero
                , string observacao
                , bool estaPago
        ...
        public List<ConciliacaoDetailUpdateDTO> Conciliacoes { get { return _conciliacoes; } }
