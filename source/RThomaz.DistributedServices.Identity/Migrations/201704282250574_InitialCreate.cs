namespace RThomaz.DistributedServices.Identity.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        StorageBucketName = c.String(nullable: false, maxLength: 56),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.AspNetUsers", "ApplicationId", "dbo.Application");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropForeignKey("dbo.AspNetRoles", "ApplicationId", "dbo.Application");
            ...
            DropIndex("dbo.AspNetRoles", new[] { "ApplicationId" });
