var MensagemBaseScript = function () {
    ...
    var initFileupload = function () {
        ...
        $('#fileupload').fileupload({
            ...
            url: '/theme/assets/global/plugins/jquery-file-upload/server/php/',
            autoUpload: true
        });
    ...
    var loadReply = function (el) {
        ...
        var url = '/Mensagem/Reply?id=' + messageid;
    ...
    return {
        ...
        init: function () {
            ...
            var title = 'Mensagens';
            var subTitle = 'gerencie suas mensagens';
