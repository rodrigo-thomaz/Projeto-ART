var ContaCorrenteDetailScript = function () {
    ...
    var handleInit = function () {
        ...
        var title = 'Conta corrente';
        var subTitle = 'gerencie suas contas corrente';
    ...
    var handleLoadForm = function () {
        ...
        if (contaId > 0) {//Edit
            ...
            $.ajax({
                type: "GET",
                url: ApplicationScript.getAppWebApiUrl() + '/api/conta/corrente/' + contaId,
                ...
                $("#cmbBanco").val(data.bancoSelectView.bancoId);
    ...
    var saveForm = function () {
        ...
        var saldoInicialValor = parseFloat($('#txtSaldoInicialValor').maskMoney('unmasked')[0].toString());
        ...
        if (contaId == 0) {
            $.ajax({
                type: "POST",
                url: ApplicationScript.getAppWebApiUrl() + '/api/conta/corrente',
                headers: { 'Authorization': 'bearer ' + ApplicationScript.getToken() },
                content: "application/json; charset=utf-8",
                dataType: "json",
                async: true,
    ...
    var bancoChange = function () {
        ...
        $("#txtNumeroConta").inputmask("mask", {
            "mask": mascaras.numeroContaCorrente
        });
