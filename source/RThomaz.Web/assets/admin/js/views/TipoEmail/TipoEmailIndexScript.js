var TipoEmailIndexScript = function () {
    ...
    var handleInit = function () {
        ...
        $("#btnNovoTipoEmail").on('click', function () {
            window.location.href = "/TipoEmail/Detail?tipo=" + tipoPessoa;
        });
        ...
        var tableColumnToggler = $('#tipoEmail_column_toggler');
    ...
    var handleInitDataTable = function () {
        ...
        oTable = $('#dataTable').dataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": ApplicationScript.getAppWebApiUrl() + "/api/tipoEmail/masterViewList?ativo=" + getAtivo() + '&tipoPessoa=' + tipoPessoa,
            ...
            "columnDefs": [
                ...
                },
                {
                    ...
                    "render": function (data, type, row) {
                        ...
                        actionControls += "<a href=\'/TipoEmail/Detail?id=" + row.tipoEmailId + "&tipo=" + tipoPessoa + "\' class=\'btn default btn-xs grey\'><i class=\'fa fa-edit\'></i> Editar</a>";
                        actionControls += "<a onclick='TipoEmailIndexScript.removeTipoEmail(\"" + row.tipoEmailId + "\",\"" + row.nome + "\");' href='#' class='btn default btn-xs grey'><i class='fa fa-trash-o'></i> Excluir</a>";
                        actionControls += "</div>";
    ...
    var handleRemoveTipoEmail = function (id, nome) {

        var message = "Deseja realmente excluir o tipo de email '" + nome + "'?";

        bootbox.confirm(message, function (result) {
            if (result) {
                $.ajax({
                    type: "DELETE",
                    url: ApplicationScript.getAppWebApiUrl() + '/api/tipoemail/' + id + '/' + tipoPessoa,
                    headers: { 'Authorization': 'bearer ' + ApplicationScript.getToken() },
                    content: "application/json; charset=utf-8",
                    dataType: "json",
                    async: true,
                    ...
                    if (data) {
                        ...
                        bootbox.alert({ message: "O tipo de email '" + nome + "' n&atilde;o pode ser exclu&iacute;do pois j&aacute; est&aacute; sendo utilizado pelo sistema." });
                    }
    ...
    var refreshDataTable = function () {
        ...
        oSettings.ajax.url = '/api/tipoEmail/masterViewList?ativo=' + getAtivo() + '&tipoPessoa=' + tipoPessoa;
    ...
    return {
        ...
        removeTipoEmail: function (id, nome) {
            handleRemoveTipoEmail(id, nome);
        }
    };
}();