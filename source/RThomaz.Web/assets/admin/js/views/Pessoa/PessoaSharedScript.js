var PessoaSharedScript = function () {
    ...
    var handleInit = function (controlId, selectViewModel) {
        ...
        $('#' + controlId).select2(
        {
            ...
            ajax: {
                quietMillis: 150,
                url: ApplicationScript.getAppWebApiUrl() + '/api/pessoa/selectViewList',
                dataType: 'json',
                ...
                results: function (data, page) {
                    ...
                    for (var i = 0; i < data.data.length; i++) {
                        results.push({
                            attr: data.data[i].tipoPessoa,
                            children: null,
                            id: data.data[i].pessoaId,
            ...
            initSelection: function (element, callback) {
                if (selectViewModel != null) {
                    callback({
                        id: parseInt(selectViewModel.pessoaId),
                        text: selectViewModel.nome,
                        attr: selectViewModel.tipoPessoa,
                    });
                }
            },
        }).select2('val', []);
