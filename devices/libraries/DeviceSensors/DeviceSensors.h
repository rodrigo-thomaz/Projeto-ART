...
#define DEVICE_SENSORS_GET_ALL_BY_DEVICE_IN_APPLICATION_ID_REQUEST_JSON_SIZE 			200
#define DEVICE_SENSORS_GET_ALL_BY_DEVICE_IN_APPLICATION_ID_RESPONSE_JSON_SIZE 			4096

#define TOPIC_PUB_DEVICE_SENSORS_GET_ALL_BY_DEVICE_IN_APPLICATION_ID   					"DeviceSensors/GetAllByDeviceInApplicationIdIoT" 
#define TOPIC_SUB_DEVICE_SENSORS_GET_ALL_BY_DEVICE_IN_APPLICATION_ID_COMPLETED		   	"DeviceSensors/GetAllByDeviceInApplicationIdCompletedIoT"
