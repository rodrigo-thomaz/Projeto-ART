...
#define DEVICE_WIFI_MAX_PARAMS 10

#define DEVICE_WIFI_SET_START_CONFIG_PORTAL_CALLBACK_SIGNATURE std::function<void()>
#define DEVICE_WIFI_SET_CAPTIVE_PORTAL_CALLBACK_SIGNATURE std::function<void(String)>
#define DEVICE_WIFI_SET_SUCCESS_CONFIG_PORTAL_CALLBACK_SIGNATURE std::function<void()>
