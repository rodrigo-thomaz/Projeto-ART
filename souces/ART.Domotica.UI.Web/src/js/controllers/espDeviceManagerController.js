'use strict';
app.controller('espDeviceManagerController', ['$scope', '$timeout', '$log', '$modal', 'uiGridConstants', '$rootScope', 'toaster', 'contextScope', 'deviceContext', 'deviceInApplicationService', 'deviceInApplicationConstant',
    function ($scope, $timeout, $log, $modal, uiGridConstants, $rootScope, toaster, contextScope, deviceContext, deviceInApplicationService, deviceInApplicationConstant) {    
        
        var onDeleteFromApplicationClick = function (espDevice) {
            deviceInApplicationService.remove(espDevice.deviceId, espDevice.deviceDatasheetId);
        }
        ...
        var clearOnDeleteFromApplicationCompleted = $rootScope.$on(deviceInApplicationConstant.removeCompletedEventName, onDeleteFromApplicationCompleted);        
