'use strict';
app.factory('unitMeasurementService', ['$http', 'ngAuthSettings', 'unitMeasurementConstant', '$rootScope', 'stompService', 'siContext',
    function ($http, ngAuthSettings, unitMeasurementConstant, $rootScope, stompService, siContext) {
