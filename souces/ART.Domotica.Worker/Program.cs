namespace ART.Domotica.Worker
{
    ...
    using ART.Domotica.Worker.AutoMapper.Globalization;
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Mapper.Initialize(x =>
            {
                ...
                x.AddProfile(new DeviceTypeProfile());
