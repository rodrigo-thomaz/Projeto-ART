...
namespace ART.Domotica.Worker.Consumers.SI
{
    public class NumericalScaleTypeCountryConsumer : ConsumerBase, INumericalScaleTypeCountryConsumer
    {
        ...
        public NumericalScaleTypeCountryConsumer(IConnection connection, ILogger logger, IComponentContext componentContext) : base(connection)
        {
        ...
        public async Task GetAllReceivedAsync(object sender, BasicDeliverEventArgs e)
        {
            ...
            //Enviando para View
            var viewModel = Mapper.Map<List<NumericalScaleTypeCountry>, List<NumericalScaleTypeCountryDetailModel>>(data);
