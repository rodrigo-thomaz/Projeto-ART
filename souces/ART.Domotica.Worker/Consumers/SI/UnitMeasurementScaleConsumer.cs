...
namespace ART.Domotica.Worker.Consumers.SI
{
    public class UnitMeasurementScaleConsumer : ConsumerBase, IUnitMeasurementScaleConsumer
    {
        ...
        public UnitMeasurementScaleConsumer(IConnection connection, ILogger logger, IComponentContext componentContext) : base(connection)
        {
        ...
        public async Task GetAllReceivedAsync(object sender, BasicDeliverEventArgs e)
        {
            ...
            //Enviando para View
            var viewModel = Mapper.Map<List<UnitMeasurementScale>, List<UnitMeasurementScaleDetailModel>>(data);
