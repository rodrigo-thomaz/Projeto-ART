...
{
    public class SensorRangeConsumer : ConsumerBase, ISensorRangeConsumer
    {
        ...
        public SensorRangeConsumer(IConnection connection, ILogger logger, IComponentContext componentContext) : base(connection)
        {
        ...
        private void Initialize()
        {
            ...
            _model.BasicConsume(SensorRangeConstants.GetAllQueueName, false, _getAllConsumer);
        }
        ...
        public async Task GetAllReceivedAsync(object sender, BasicDeliverEventArgs e)
        {
            ...
            var domain = _componentContext.Resolve<ISensorRangeDomain>();
