...
namespace ART.Domotica.Domain.Services.SI
{
    public class NumericalScaleTypeCountryDomain : DomainBase, INumericalScaleTypeCountryDomain
    {
        ...
        public NumericalScaleTypeCountryDomain(INumericalScaleTypeCountryRepository numericalScaleTypeCountryRepository)
        {
            _numericalScaleTypeCountryRepository = numericalScaleTypeCountryRepository;
        }
