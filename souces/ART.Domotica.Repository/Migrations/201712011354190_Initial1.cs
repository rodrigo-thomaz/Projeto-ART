namespace ART.Domotica.Repository.Migrations
{
    ...
    public partial class Initial1 : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Country", "NumericalScaleId", "SI.NumericalScale");
                ...
                c => new
                    {
                        ...
                        NumericalScaleId = c.Byte(nullable: false),
                        Name = c.String(nullable: false, maxLength: 5, fixedLength: true),
                        CientificNotation = c.Single(nullable: false),
                    })
