namespace ART.Domotica.Repository.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.SensorBase", "TempSensorRangeId", "dbo.TempSensorRange");
            DropForeignKey("dbo.SensorBase", "TemperatureScaleId", "dbo.TemperatureScale");
            ...
            DropIndex("dbo.SensorBase", new[] { "TemperatureScaleId" });
            DropIndex("dbo.SensorBase", new[] { "TempSensorRangeId" });
