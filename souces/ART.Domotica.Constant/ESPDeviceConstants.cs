namespace ART.Domotica.Constant
{
    public static class ESPDeviceConstants
    {
        ...
        public static readonly string DeleteFromApplicationIoTQueueName = "DeleteFromApplicationIoT";
        ...
        public static readonly string InsertInApplicationIoTQueueName = "InsertInApplicationIoT";
        ...
        public static readonly string UpdatePinIoTQueueName = "UpdatePinIoT";
